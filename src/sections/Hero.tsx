...
import { ContactButton, GhostLink } from '../components/Buttons'
...
export default function Hero() {
  return (
    ...
    >
      ...
      >
        <span className="text-mist font-extrabold uppercase tracking-wider text-lg md:text-2xl">
          Varsan<span className="text-pumpkin">.</span>
        </span>
        <div className="flex gap-6 md:gap-10 text-mist font-medium uppercase tracking-wider text-sm md:text-lg lg:text-[1.4rem]">
          {NAV.map(([label, href]) => (
